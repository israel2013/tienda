                ...
                <div class="card"
                  ...
                  <div class="table-responsive">
                    <table class="table table-sm table-hover table-nowrap card-table">
                      ...
                      <!--si load data no es falso no muestra el circulo de carga -->
                      <paginate  
                      tag="tbody" 
                      ref="colaboradores" 
                      name="colaboradores"
                      ...
                      class="list fs-base">
                        <tr v-if="!load_data" v-for="item in paginated('colaboradores')">
                          ...
                          <td>
                            ...
                            <!-- Email -->
                            <a class="item-email text-reset" href="mailto:john.doe@company.com">{{ item.email }}</a>

                          </td>
                          <td>

                            <!-- Badge -->
                            <span v-if="!item.estado" class="item-score badge bg-danger-soft">Desactivado/10</span>


                            <span v-if="item.estado" class="item-score badge bg-success-soft">Activo/10</span>
                          ...
                          <td class="text-end">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <sapm v-if="item.estado">Desactivar</sapm>
                                <sapam v-if="!item.estado">Activar</sapam>
                                </a>
...
export default {
  ...
  //metodo para cambiar de pagina con el next
  methods: {
    onLangsPageChange(toPage, fromPage) {
      // handle here…

      //obtenemos la pagina en donde estamos
    ...
    //hacemos uns consulta hacia bakend para el filtrado
    init_data() {
      this.load_data = true;
      axios.get(this.$url + '/listar_usuario_admin/' + this.filtro, {
        ...
        //cuando me devuelva la respuesta lo ponemos en falso de nuevo
    ...
    //metodo para cabiar el estado de un usuario
    eliminar(id,estado){
      console.log(id);
  ...
  //hub del ciclo de vida de un componente
  //se ejecuta antes de que la intancia de vue se monte en el dom 
  beforeMount() {
    this.init_data();
  },
