  ...
  <div class="card-header">
   ...
   <div class="card-body">
       ...
       <template v-if="!load_data">
        ...
        <div>
            <ul id="my-table" class="list-group list-group-lg list-group-flush list my-n4" v-if="productos.length
                                                     >= 1">
                                        ...
                                        <div class="row justify-content-center">
    <div class="col-12 col-md-6 col-xl-6 my-5" v-if="productos.length == 0">
...
export default {
    ...
    methods: {
        ...
        //obtenemos los productos de la base de datos y los mostramos
        init_data() {
            this.load_data=true;
