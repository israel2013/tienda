      ...
      <div class="row">
        ...
        <div class="col-lg-5 ps-lg-4 order-1 order-lg-2">
          <ul class="breadcrumb undefined">
            ...
            <li class="breadcrumb-item"><router-link to="/tienda">Tienda</router-link></li>
            <li class="breadcrumb-item"><router-link :to="{name: 'tienda',query: {categoria:producto.categoria}}">{{producto.categoria}}</router-link></li>
          </ul>
